...
class Add:
    ...
    def compute_sum(self):
        try:
            ...
            messagebox.showwarning("Error1", "Check input again!")
    ...
    def output_matrix(self):
        ...
        Button(self.frame_add_output, text="Back", width=4, command=self.back_to_menu).grid(row=self.rows_get + self.rows_get + 10, column=1)
        ...
        Label(self.frame_add_output, text='Matrix B:', font=('arial', 10, 'bold'), underline=0).grid(row=1, column=self.cols_get+2)
        ...
        Label(self.frame_add_output, text='Sum:', font=('arial', 10, 'bold'), underline=0).grid(row=self.rows_get * 2,column=1)
        ...
        for i in range(len(self.sum_matrix)):
            Label(self.frame_add_output, text=self.sum_matrix[i], bd=5).grid(row=i + self.rows_get * 2, column=2, columnspan=5, sticky='w  ')
    ...
    def input_matrix(self):
        ...
        def get_mat():
            try:
                ...
                messagebox.showwarning("Error4!","Check input again!")
    ...
    def __init__(self):
        ...
        OptionMenu(self.frame_add_menu, self.rows, *range(2, 10)).grid(row=3, column=2)
        ...
        OptionMenu(self.frame_add_menu, self.cols, *range(2, 10)).grid(row=3, column=4)
